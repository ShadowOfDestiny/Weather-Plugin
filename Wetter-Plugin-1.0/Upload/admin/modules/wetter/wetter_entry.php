...
$form_container->output_row($lang->wetter_admin_temperature." <em>*</em>", "", $form->generate_text_box('temperatur', $mybb->input['temperatur']), 'temperatur');
$form_container->output_row($lang->wetter_admin_condition." <em>*</em>", "", $form->generate_text_box('wetterlage', $mybb->input['wetterlage']), 'wetterlage');
// Sonnenaufgang (HH:MM)
...
$form_container->output_row($lang->wetter_admin_moonphase, "", $form->generate_text_box('mondphase', $mybb->input['mondphase']), 'mondphase');
...
// Windstärke
$form_container->output_row($lang->wetter_admin_windspeed, "", $form->generate_text_box('windstaerke', $mybb->input['windstaerke']), 'windstaerke');
